"""
Simple ZMQ stream listener for DECTRIS ARINA.

Connects to DCU, decodes CBOR frames, prints frame count.
Run this before starting a scan.

Based on DECTRIS StreamTest.py -- decode logic unchanged.
"""
...
dcu_ip = "11.0.0.1"
zmq_port = 31001
verbose = False  # Set to True to print every message
...
if __name__ == "__main__":
    ...
    context = zmq.Context()
    endpoint = f"tcp://{dcu_ip}:{zmq_port}"
